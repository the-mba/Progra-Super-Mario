...
class Mario(Solid):
    def __init__(self, PLAYER_STARTING_X, PLAYER_STARTING_Y, PLAYER_WIDTH, PLAYER_TALLNESS, PLAYER_CONSTANT_VEL_X, PLAYER_STARTING_VEL_Y, BACKGROUND_RIGHT_MOVEMENT_THRESHOLD, FLOOR_HEIGHT, GRAVITY, JUMPING_COEFFICIENT) -> None:
        super().__init__(PLAYER_STARTING_X, PLAYER_STARTING_Y, PLAYER_WIDTH, PLAYER_TALLNESS, 0, PLAYER_STARTING_VEL_Y)
