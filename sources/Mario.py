...
class Mario(Solid.Solid):
    ...
    def __init__(self, MARIO_STARTING_X, MARIO_STARTING_Y, MARIO_CONSTANT_VEL_X, MARIO_STARTING_VEL_Y, MARIO_WIDTH, MARIO_TALLNESS, MARIO_SPRITE_X, MARIO_SPRITE_Y, PERSISTENT, FLOOR_HEIGHT, BACKGROUND_RIGHT_MOVEMENT_THRESHOLD, GRAVITY, JUMPING_COEFFICIENT) -> None:
        super().__init__(MARIO_STARTING_X, MARIO_STARTING_Y, 0, MARIO_STARTING_VEL_Y, MARIO_WIDTH, MARIO_TALLNESS, MARIO_SPRITE_X, MARIO_SPRITE_Y, PERSISTENT, FLOOR_HEIGHT)
